...
console.log("Please enter the number of the planet you will be travelling to using the following system. 1-Venus, 2-Mars, 3-Jupiter, 4-Saturn, 5-Uranus, 6-Neptune: ")
